...
<section className="relative mx-auto -mt-2 max-w-4xl text-center">
  ...
  {/* Description */}
<p className="mx-auto mt-7 max-w-2xl text-[15px] leading-7 text-slate-200 sm:text-base">    Upload a screenshot and let AI analyze its layout, styling,
    and components to generate a React + Tailwind implementation.
  </p>
